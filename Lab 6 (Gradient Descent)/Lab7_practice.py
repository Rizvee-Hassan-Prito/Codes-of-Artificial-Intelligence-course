# -*- coding: utf-8 -*-
"""
Created on Sat Dec 25 21:56:18 2021
...
##Ploting Gradient Descent Contour Plot
...
for i in range(len(old_w)-1):
    plt.annotate('', xy=ws[i+1, :], xytext=ws[i, :], arrowprops={'arrowstyle': '->', 'color': 'r', 'lw': 1}, va='center', ha='center')
